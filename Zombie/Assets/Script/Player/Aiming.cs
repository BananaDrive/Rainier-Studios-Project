...
public class Aiming : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector2 rotationDistance = new(1.1f * aimSide * Mathf.Cos(aimDirection * Mathf.PI / 2), 1.1f * Mathf.Sin(aimDirection * Mathf.PI / 2)); //makes the weapon seem like its orbiting the player
